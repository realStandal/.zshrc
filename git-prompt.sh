...
#    3) Alternatively, for a slightly faster prompt, __git_ps1 can
...
__git_ps1_colorize_gitstring ()
{
	...
	local ok_color=$C_LBLUE
	local flags_color=$C_GREEN
...
':/*' >/dev/null 2>/dev/null
	...
	if [ $pcmode = yes ]; then
		...
		PS1="$ps1pc_start$C_GRAY($C_CLEAR$gitstring$C_GRAY) $C_CLEAR$ps1pc_end"
	else
